...
export default function EmirateVideoIntro({ onDismiss }) {
  ...
  return (
    ...
    >
      {/* Video — full cover */}
      <video
        src="https://res.cloudinary.com/deivg8apm/video/upload/v1783737414/grok-video-5cd16c07-f90f-4aee-bb2a-eec9992a78ef_svbmw8.mp4"
        autoPlay
        muted
        playsInline
        onEnded={() => {
