...
const VIDEO_SRC =
  'https://res.cloudinary.com/deivg8apm/video/upload/v1783840621/grok-video-556b1ac4-4467-41c6-ab06-5292d2b88c73_1_sir6u8.mp4';

const INTRO_SECONDS = 8;
const RING_RADIUS = 40;
const RING_CIRCUMFERENCE = 2 * Math.PI * RING_RADIUS; // ≈ 251

export default function RasAlKhaimahVideoIntro({ onDismiss }) {
