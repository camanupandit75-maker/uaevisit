...
const VIDEO_SRC =
  'https://res.cloudinary.com/deivg8apm/video/upload/v1783741336/imagine-d07af288_a0kgin.mp4';

const INTRO_SECONDS = 12;
const RING_RADIUS = 40;
const RING_CIRCUMFERENCE = 2 * Math.PI * RING_RADIUS; // ≈ 251

export default function FujairahVideoIntro({ onDismiss }) {
  ...
  useEffect(() => {
    // Hard 12-second ceiling — fire fade regardless of video length
